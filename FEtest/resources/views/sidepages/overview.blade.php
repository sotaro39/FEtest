...
@section('content')
    ...
    <section class="side-section">
        ...
        <p>国家試験である情報技術者試験の試験区分の一つです。
            ...
            この試験で得た知識をもとにレベル3の応用技術者試験や、さらに各分野が問われるレベル4の高度試験などを目指すことができます。
        </p>
        <h6>2.受験資格や年齢制限はない</h6>
        <p>基本情報技術者に限らず、情報処理技術者試験を受験するのに特別な条件はありません。
            年齢、実務経験、学歴などを問わずどなたでも挑戦していただける試験です。
        </p>
        <h6>3.受験料</h6>
        <p><strong>7,500</strong>円(税込み)です。
            <br>
            クレジットカード・コンビニエンスストア払い・Pay-easy払いが選択可能ですが、振込手数料は各自の負担となります。
            領収書は、株式会社シー・ビーティ・ソリューションズ(CBTS)の受験者専用サイト上のマイページからダウンロードできます。
        </p>
        <h6>4.受験日の日程</h6>
        <p>2023年4月より試験が通年化されたため、年間を通していつでも受験することができます。
            ただし、受験した後はその後<strong>30</strong>日間は再受験できないというリテイクポリシーがあるので、受験可能なのは30日に1回までとなります。
        </p>
        <h6>5.試験方式</h6>
        <p>コンピュータの画面上に出題される問題に対して、マウス操作で正しい解答を選択していく<strong>CBT</strong>(Computer Based Testing)方式で行われます。
        </p>
        <h6>6.試験形式</h6>

        <P>科目A試験と科目B試験に分かれており、両方の試験で<strong>60></strong>%以上の得点をとることで合格となります。
            科目A試験と科目B試験は同日受験です。
        </P>
        <dl>
            <dt>科目A試験</dt>
        ...
        <p>独立行政法人『情報処理推進機構』
            ...
            <br><br>
            ホームページ:<a href="#">https://www.ipa.go.jp/shiken/</a>
            <br>
            問い合わせ先:<a href="#">https://www.ipa.go.jp/contact.html</a>
    </section>
@endsection()
